			...
			<!-- begin:: Subheader -->
				<div class="kt-subheader   kt-grid__item" id="kt_subheader">
					<div class="kt-subheader__main">
                        ...
                        <h4 class="kt-subheader__desc">Modifier votre role</h4>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="kt-portlet">
                                <!--begin::Form-->
                                <form class="kt-form" method="POST" action="{{ route('role.update') }}">
                                    <div class="kt-portlet__body"> 
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-3">
                                                ...
                                                <input type="text" class="form-control" value="{{$role->role_name}}" id="role_name" name="role_name" required>
                                            ...
                                            <div class="col-lg-3">
												...
												<div class="col-2">
													<span class="kt-switch kt-switch--sm kt-switch--icon">
														<label>
                                                            <input type="checkbox" id="role_pro" name="role_pro">
                                                            <span></span>
														</label>
													</span>
												</div>
                                            ...
                                            <div class="col-lg-2">
												...
												<div class="col-2">
													<span class="kt-switch kt-switch--sm kt-switch--icon">
														<label>
                                                            <input type="checkbox" id="role_res" name="role_res">
                                                            <span></span>
														</label>
													</span>
												</div>
                                            ...
                                            <div class="col-lg-2">
												...
												<div class="col-2">
													<span class="kt-switch kt-switch--sm kt-switch--icon">
														<label>
                                                            <input type="checkbox" id="role_edimestre" name="role_edimestre">
                                                            <span></span>
														</label>
													</span>
												</div>
