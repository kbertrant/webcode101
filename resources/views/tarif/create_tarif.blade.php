            ...
            <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
                ...
                <div class="kt-subheader   kt-grid__item" id="kt_subheader">
                    <div class="kt-subheader__main">
                        ...
                        <h4 class="kt-subheader__desc">Créer une tarification</h4>
                    </div>
                </div>
                <!-- end:: Subheader -->
                <!-- begin:: Content -->   
                <div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <!--begin::Form-->
                                <form class="kt-form" method="POST" action="{{ route('tarif.store') }}">
                                    <div class="kt-portlet__body">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-6">
                                                ...
                                                <input type="text" class="form-control" placeholder="" id="tarif_jour" name="tarif_jour" required>  
                                            </div>
                                            <div class="col-lg-6">
                                                <label class="">Tarif soir:</label>
                                                <input type="text" class="form-control" placeholder="" id="tarif_soir" name="tarif_soir" required>   
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-lg-6">
                                                <label>Tarif nuit:</label>
                                                <input type="text" class="form-control" placeholder="" id="tarif_nuit" name="tarif_nuit" required>            
                                            </div>
                                        </div>
